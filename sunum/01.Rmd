...
=======
**1.** Ölçme ve değerlendirme dersi ile ilgili kavramları kendi derslerinde kullanır.

**1.** Hazırlanan bir ölçme aracında olması gereken temel özellikleri sıralar.

**1.** Psikometrinin güvenirlik ve geçerlik gibi tekniklerinin teorik temellerini anlar.

**1.** Güvenirlik ve geçerlilik tekniklerini gerçek veri setlerinde uygulayabilir.

**1.** Eğitimde ölçme ve değerlendirme yapmanın önemini açıklar.

**1.** Eğitimde kullanılan sonuç ve süreç odaklı ölçme araçlarının özelliklerini bilir ve hazırlar.

**1.** Test istatistiklerini kullanarak test sonucunda oluşan dağılımları yorumlar.
>>>>>>> a11d3074277692af7ddd916093b66445eeeeaa16

**1.** Uygulanan ölçme araçlarından alınan öğrenci çıktısını değerlendirir ve öğrenciye not verir.
...
=======
-   **25% Ara Sınav**  ders saatinde gerçekleştirilecektir.
...
---
## `r advdate(mon, 3)`: Ölçme ve değerlendirmede temel kavramlar

<<<<<<< HEAD
=======
Ders öncesi Hafta 2 konularını kapsayan uygulama yapılacaktır.
>>>>>>> a11d3074277692af7ddd916093b66445eeeeaa16
...
---
## `r advdate(mon, 5)`: Değerledirme

 Ders başlangıcında ilk üç hafta konularını kapsayan bir mini sınav uygulaması yapilacaktir.

Değerlendirme öğeleri ve türleri

Mutlak değerlendirme ve bağıl değerlendirme
...
## `r advdate(mon, 5)`: Ölçmede hata ve korelasyo
=======
## `r advdate(mon, 5)`: Ölçmede hata ve korelasyon

>>>>>>> a11d3074277692af7ddd916093b66445eeeeaa16
## `r advdate(mon, 6)`:  Ölçmede hata ve korelasyon

. Ders kaydında size odev olarak bırakılan sayfalar sinifta tartısılacaktir.
...
---
## `r advdate(mon, 8)`:Ölçme araçlarının temel nitelikleri I

Ders başlangıcında ölçmede hata ve güvenirlik konularini kapsayan bir mini sınav uygulaması yapilacaktir.

Güvenirlik

Güvenirlik hesaplanma yöntemleri

---
## `r advdate(mon, 9)`: Ölçme araçlarının temel nitelikleri II

 Ders başlangıcında çeşitli ölçme durumları sizlerle paylaşılacak ve paylaşımları ölçme araçlarında aranan temel nitelikler açısından değerlendirmeniz beklenecektir.
...
Ders başlangıcında farklı madde türleri sizlere paylaşılacak ve madde türlerini madde yazım kuralları açısından değerlendirmeniz beklenecektir.
...
Sizlere Madde Analizi Ödeviniz ders başlangıcında ayrıntılı olarak açıklanacak ve iki hafta sonra bu ödevi teslim etmeniz beklenecektir. Ödev ile ilgili ayrıntıları moodle üzerinden takip ediniz.
